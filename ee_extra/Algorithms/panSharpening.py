...
PLATFORM_BANDS = {
    ...
    "LANDSAT/LC09/C02/T1_L2": L9_BANDS,
    "LANDSAT/LC09/C02/T1": L9_BANDS,
    "LANDSAT/LC09/C02/T1_RT": L9_BANDS,

    # Landsat 8 (LC08)
    "LANDSAT/LC08/C02/T1_TOA": L8_BANDS,
    "LANDSAT/LC08/C02/T1_RT_TOA": L8_BANDS,
    "LANDSAT/LC08/C02/T1_L2": L8_BANDS,
    "LANDSAT/LC08/C02/T1": L8_BANDS,
    "LANDSAT/LC08/C02/T1_RT": L8_BANDS,
    "LANDSAT/LC08/C02/T2": L8_BANDS,
    "LANDSAT/LC08/C02/T2_TOA": L8_BANDS,

    # Landsat 7 (LE07)
    "LANDSAT/LE07/C02/T1_TOA": L7_BANDS,
    "LANDSAT/LE07/C02/T1_L2": L7_BANDS,
    "LANDSAT/LE07/C02/T1": L7_BANDS,
    "LANDSAT/LE07/C02/T2": L7_BANDS,
    "LANDSAT/LE07/C02/T2_TOA": L7_BANDS,
}
